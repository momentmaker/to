...
def test_build_scheduler_registers_weekly_reminder_by_default(conn):
    ...
    assert ids == {"process_pending", "nightly_sync", "daily_sparks", "daily_prompt", "weekly_reminder", "tweet_draft_expiry"}
...
def test_build_scheduler_registers_weekly_digest_when_explicitly_enabled(conn):
    ...
    assert ids == {"process_pending", "nightly_sync", "daily_sparks", "daily_prompt", "weekly_digest", "tweet_draft_expiry"}
